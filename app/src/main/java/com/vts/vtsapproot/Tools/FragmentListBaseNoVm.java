...
public abstract class FragmentListBaseNoVm<
                ...
                public boolean onTouch(View view, MotionEvent event) {
                    switch (event.getActionMasked()) {
                        ...
                        case MotionEvent.ACTION_MOVE:
                            ...
                            newX = Math.max(55, Math.min(newX, parent.getWidth() - view.getWidth() - 55));
                            newY = Math.max(55, Math.min(newY, parent.getHeight() - view.getHeight() - 55));
                        ...
                        case MotionEvent.ACTION_UP:
                            ...
                            if (clickDuration < MAX_CLICK_DURATION) {
                                ...
                                if (view.getX() + (view.getWidth() / 2f) < screenWidth / 2f) {
                                    finalX = 55; // Hút về cạnh trái
                                } else {
                                    finalX = screenWidth - view.getWidth() - 55; // Hút về cạnh phải
                                }
